...
proc main() =
    ...
    testShape.init(eg.renderer.program(0), testVertices2, testIndices)
    ...
    while eg.nextFrame():
        ...
        let r = rect(16.0 * float(rand(13)), 16.0 * float(rand(6)), 32.0, 32.0)
        #let r = rect(0.0, 0.0, 16.0, 16.0)
        #let r = rect(0.0, 0.0, 240.0, 128.0)
        eg.renderer.draw(testShape, testImage, instance(r, mat4f()))
